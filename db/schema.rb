...
ActiveRecord::Schema.define(version: 20140616213417) do

  create_table "answer_value_entries", force: true do |t|
    t.integer  "answer_id"
    t.text     "value"
  ...
  add_index "answer_value_entries", ["answer_id"], name: "index_answer_value_entries_on_answer_id"
